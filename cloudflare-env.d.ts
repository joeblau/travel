/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: e7ebc3d82a9c09e721e931ac37aa323f)
// Runtime types generated with workerd@1.20260111.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		NEXT_PUBLIC_MAPBOX_TOKEN: string;
		WORKER_SELF_REFERENCE: Fetcher /* travel */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_MAPBOX_TOKEN">> {}
}
